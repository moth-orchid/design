...
<BODY>
	<s:actionerror />
	<s:fielderror/>
	<s:form id="form1" name="form1" method="post"  action="customer_update" namespace="/" enctype="multipart/form-data" theme="simple">
	<s:hidden name="cust_id" value="%{cust_id}" />
	<s:hidden name="cust_image" value="%{cust_image}"/>
	<%-- <FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/customer_add2.action"
